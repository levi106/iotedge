...
use crate::constants::{
    ...
    PROXY_CONFIG_VOLUME_NAME, PROXY_CONTAINER_NAME,
...
mod tests {
    ...
    use crate::constants::{
        ...
        PROXY_CONTAINER_NAME, PROXY_TRUST_BUNDLE_VOLUME_NAME,
    };
    use crate::convert::{
    ...
    fn create_module_spec() -> ModuleSpec<DockerConfig> {
        ...
        ModuleSpec::new(
            "$edgeAgent".to_string(),
            "docker".to_string(),
            DockerConfig::new("my-image:v1.0".to_string(), create_body, None, Some(auth_config)).unwrap(),
            {
