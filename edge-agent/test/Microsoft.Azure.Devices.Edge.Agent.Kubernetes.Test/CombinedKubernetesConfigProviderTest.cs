...
""cmd"" : [
  ...
  ""argument4""
        ...
        public void CmdEntryOptionsWillExist()
        {
            ...
            module1.SetupGet(m => m.Config).Returns(new DockerConfig("nginx:latest", CmdCreateOptions, Option.None<string>()));
            module1.SetupGet(m => m.Name).Returns("mod1");
            var module2 = new Mock<IModule<DockerConfig>>();
            module2.SetupGet(m => m.Config).Returns(new DockerConfig("nginx:latest", CmdCreateOptionsLC, Option.None<string>()));
...
""entrypoint"" : [
  ""a-command2""
        ...
        public void EntrypointOptionsWillExist()
        {
            ...
            var module1 = new Mock<IModule<DockerConfig>>();
            module1.SetupGet(m => m.Config).Returns(new DockerConfig("nginx:latest", EntryPointCreateOptions, Option.None<string>()));
            module1.SetupGet(m => m.Name).Returns("mod1");
            var module2 = new Mock<IModule<DockerConfig>>();
            module2.SetupGet(m => m.Config).Returns(new DockerConfig("nginx:latest", EntryPointCreateOptionsLC, Option.None<string>()));
            module2.SetupGet(m => m.Name).Returns("mod1");
...
""workingdir"" : ""a-directory2""
        ...
        public void WorkingDirOptionsWillExist()
        {
            ...
            var module1 = new Mock<IModule<DockerConfig>>();
            module1.SetupGet(m => m.Config).Returns(new DockerConfig("nginx:latest", WorkingDirCreateOptions, Option.None<string>()));
            module1.SetupGet(m => m.Name).Returns("mod1");
            var module2 = new Mock<IModule<DockerConfig>>();
            module2.SetupGet(m => m.Config).Returns(new DockerConfig("nginx:latest", WorkingDirCreateOptionsLC, Option.None<string>()));
            module2.SetupGet(m => m.Name).Returns("mod1");
